...
const Navbar = () => {
  ...
  const OpenPDF = () => {
    ...
    const url = `https://drive.google.com/file/d/1CYdkqF7_ByEG5KJVFPLuP2yBOraPb2R5/view?usp=share_link`
